...
import {
  handleLogin, renderSecurePage, handleMemeCreation, handleSendingAllMemes, handleSendingMeme,
} from '../controllers/p9Controller.js';

Utils.createDir('public/p9-memes');

const p9Router = express.Router();

const renderLoginPage = renderSecurePage({ page: 'login', redirectTo: '/p9/memechat', directTo: 'p9-login.html' });
const renderMemechatPage = renderSecurePage({ page: 'memechat', redirectTo: '/p9/login', directTo: 'p9-memechat.html' });
